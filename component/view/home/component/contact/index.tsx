  ...
  return (
    <Fragment>
      <div className="flex flex-col gap-2">
        <div className="container mx-auto grid grid-cols-2 gap-4 p-20 bg-[#101014] rounded-xl px-20">
          <div className="flex flex-col gap-12 justify-start h-full">
            ...
            <ul className="flex flex-col gap-4 border-[#D0D1DB1A] border-b pb-6">
              <li>
                <p className="text-lg text-[#D0D1DB] tracking-[-0.1px] leading-[170%]">
                  <b className="text-white font-semibold">Office</b> &nbsp; 150
                  Old Park Ln, London W1K 1QZ
                </p>
              </li>
              <li>
                <p className="text-lg text-[#D0D1DB] tracking-[-0.1px] leading-[170%]">
            ...
            <div>
              <p className="font-semibold text-white tracking-[-0.1px] leading-[170%]">
                Follow Us
              </p>
