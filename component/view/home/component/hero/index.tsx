      ...
      <div className="bg-[#101014] h-screen flex items-end min-[1440px]:items-center pb-8 min-[1440px]:pb-0 relative -z-20 min-[1440px]:z-auto">
        <div className="container mx-auto grid grid-cols-1 min-[1440px]:grid-cols-2 gap-4 px-10 min-[1440px]:px-20 relative mb-3 lg:mb-8 min-[1440px]:!mb-0">
          ...
          <div className="hidden flex-col items-center justify-center h-full min-[1440px]:!flex">
            <div className="w-[40.795rem] h-[52.219rem] rounded-xl overflow-hidden relative">
              <Image
        ...
        <div className="absolute w-full px-5 -z-10 block min-[1440px]:!hidden">
          <div className="rounded-xl w-full h-[calc(100vh-130px)] bg-[#101014] mx-auto relative overflow-hidden">
            <Image
              src={"/dining-area-brazilian-folklore-decor.png"}
              alt="LifetimeArt Hero Image"
